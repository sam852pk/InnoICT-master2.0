...
<script src="js/jquery.1.8.3.min.js"></script>
  ...
  <div class="container">
	...
	<div class="row">
		<form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" id="upload_form">
			<div class="col-md-offset-1 col-md-5">
				...
				<div class="form-group">
					<div class="row" >
						...
						<input type="file" name="file1" multiple ="multiple" id="file1" class="file">
			...
			<div class="col-md-offset-1 col-md-5">				
				...
				<div class="form-group text-right">
					<button class="btn btn-xs btn-primary2 btn-round" onclick="uploadFile()">繼續</button>	
	...
	<?php include '_footer.php';?>
      ...
      <script>
        ...
        //ajax.open("POST", "upload_v.php");
        ajax.open("POST", "PHP/upload_detail.php");
        //ajax.open("POST", "php/you.php");
        console.log('response=', ajax.responseXML);
        ajax.send(formdata);
